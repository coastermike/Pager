...
//    #include "WirelessProtocols/Console.h"
    ...
    void SPIPutFlash(BYTE v);
    BYTE SPIGetFlash(void);
    ...
    void PHYSetLongRAMAddr(INPUT WORD address, INPUT BYTE value)
    {
        ...
        RFIE = 0;
        PHY_CS = 0;
        SPIPutFlash((((BYTE)(address>>3))&0x7F)|0x80);
        SPIPutFlash((((BYTE)(address<<5))&0xE0)|0x10);
        SPIPutFlash(value);
        PHY_CS = 1;
        RFIE = tmpRFIE;
    }
    ...
    BYTE PHYGetLongRAMAddr(INPUT WORD address)
    {
        ...
        RFIE = 0;
        PHY_CS = 0;
        SPIPutFlash(((address>>3)&0x7F)|0x80);
        SPIPutFlash(((address<<5)&0xE0));
        toReturn = SPIGetFlash();
        PHY_CS = 1;
        RFIE = tmpRFIE;
